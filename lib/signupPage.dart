              ...
              Column(
                children: [
                  ElevatedButton.icon(
                    ...
                    icon: Image.asset('assets/image/gmail.png', height: 24),
                    label: Text('Gmail'),
                  ...
                  ElevatedButton.icon(
                    ...
                    icon: Image.asset('assets/image/facebook.png', height: 24),
                    label: Text('Facebook'),
                    style: ElevatedButton.styleFrom(
                      minimumSize: Size(double.infinity, 48),
                    ),
                  ...
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: Image.asset('assets/image/twitter.png', height: 24),
                    label: Text('Twitter'),
                    style: ElevatedButton.styleFrom(
                      minimumSize: Size(double.infinity, 48),
                    ),
